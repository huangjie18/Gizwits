...
* @{
*/
#define PRODUCT_KEY "87f34867cdc7400da93c8d3a21cdb452"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "3d6593235979453aa2a16694e6537598"
...
* @{
*/
#define LED0on_off_BYTEOFFSET                    0
#define LED0on_off_BITOFFSET                     0
#define LED0on_off_LEN                           1
#define LED1on_off_BYTEOFFSET                    0
#define LED1on_off_BITOFFSET                     1
#define LED1on_off_LEN                           1
...
typedef struct {
  bool valueLED0on_off;
  bool valueLED1on_off;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagLED0on_off:1;
  uint8_t flagLED1on_off:1;
} attrFlags_t;
